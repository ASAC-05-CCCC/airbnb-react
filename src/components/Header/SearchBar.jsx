const SearchBar = () => {
  return (
    <div className='absolute flex justify-center sm:w-[600px] py-6 top-10 cursor-pointer'>
      {/* Search Bar */}
      <div className='flex items-center w-full max-w-4xl bg-white rounded-full shadow-md'>
        {/* 여행지 검색 */}
        <div className='px-6 py-2 overflow-hidden rounded-full hover:bg-gray-200'>
